...
## Sistema ProyectoAuto — Repo + Antigravity + NotebookLM + Entregables

**Propósito:** Este repositorio existe para **desarrollar el Proyecto_automatizaciones** de forma ordenada, trazable y repetible, permitiendo **explorar varias opciones (nichos/pivotes)** y, una vez elegida una opción, ejecutar **linealmente** el cronograma de entregables del programa.
