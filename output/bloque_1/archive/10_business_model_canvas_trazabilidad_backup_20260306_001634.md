...
- Coste fijo bajo si se fundamenta en Serverless / API-based operations. (LLM token costs, Cloud Storage, Hosting backend/frontend).
- Principal coste estructural interno: Horas de parametrización e integración inicial adaptada a las singularidades de cada cliente. 
...
- **note_title:** HITO: Business Model Canvas
- **note_id:** e5598ae6-a5d2-4e88-8983-08c92c27f962
- **fecha:** 2026-03-04
